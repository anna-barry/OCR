...
void cb_openpageOCR (GtkWidget *p_widget, gpointer user_data)
{
  ...
  gtk_window_set_title (GTK_WINDOW (d_window), "OCR");
  ...
  //create the save button
  {
    ...
    g_signal_connect (G_OBJECT (d_button), "clicked", G_CALLBACK (cb_open_ocr), NULL);
